from classes import Gerenciador, limpartela
...
def menu_vendas():
    while True:
        ...
        if opcao == "1":
            ...
            gerenciador.registrar_venda(id_cliente, id_vendedor, itens)
        elif opcao == "2":
...
def menu_relatorios():
    while True:
        ...
        if opcao == "1":
            gerenciador.relatorio_clientes()
        elif opcao == "2":
            gerenciador.relatorio_produtos()
        elif opcao == "3":
            gerenciador.relatorio_vendas()
        elif opcao == "0":
            break
        else:
            print("Opção inválida! Pressione Enter para continuar.")
